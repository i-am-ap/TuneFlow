...
# else:
#     if IS_LOCAL:
#         raise RuntimeError("Set SPOTIFY_CLIENT_ID and SPOTIFY_CLIENT_SECRET in your local .env")
#     else:
#         logger.warning("⚠️ Spotify credentials missing. Spotify search will not work.")

# # -----------------------------
# # Download folder setup
# # -----------------------------
# LOCAL_DOWNLOADS = os.path.join(BASE_DIR, "downloads")
# PROD_DOWNLOADS = os.path.join("/tmp", "downloads_prod")  # ephemeral storage in Railway
# SAVE_PATH = LOCAL_DOWNLOADS if IS_LOCAL else PROD_DOWNLOADS
# os.makedirs(SAVE_PATH, exist_ok=True)
...
# # -----------------------------
# if __name__ == '__main__':
#     PORT = int(os.getenv('PORT', 8080))    #7860
#     DEBUG = IS_LOCAL or os.getenv("FLASK_DEBUG", "1") == "1"
